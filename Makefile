...
PROJECT_NAME=plone.org.br
STACK_NAME=plone-org-br
...
stack-start:  ## Local Stack: Start Services
	...
	@echo "Now visit: http://plone.org.br.localhost"
...
acceptance-frontend-image-build:
	...
	@docker build frontend -t luxcas/plone.org.br-frontend:acceptance -f frontend/Dockerfile --build-arg VOLTO_VERSION=$(VOLTO_VERSION)

.PHONY: acceptance-backend-image-build
acceptance-backend-image-build:
	@echo "Build acceptance backend image"
	@docker build backend -t luxcas/plone.org.br-backend:acceptance -f backend/Dockerfile.acceptance --build-arg PLONE_VERSION=$(PLONE_VERSION)
...
acceptance-frontend-container-start:
	@echo "Start acceptance frontend"
	@docker run --rm -p 3000:3000 --name plone.org.br-frontend-acceptance --link plone.org.br-backend-acceptance:backend -e RAZZLE_API_PATH=http://localhost:55001/plone -e RAZZLE_INTERNAL_API_PATH=http://backend:55001/plone -d luxcas/plone.org.br-frontend:acceptance

.PHONY: acceptance-backend-container-start
acceptance-backend-container-start:
	@echo "Start acceptance backend"
	@docker run --rm -p 55001:55001 --name plone.org.br-backend-acceptance -d luxcas/plone.org.br-backend:acceptance
...
acceptance-containers-stop: ## Stop Acceptance containers
	...
	@docker stop plone.org.br-frontend-acceptance
	@docker stop plone.org.br-backend-acceptance
